                    ...
                    slotContents.map((data) => {
                      return (
                        <Link
                          ...
                          key={data.id}
                          className="col-6 col-sm-6 col-lg-4 col-xl-3 my-2 text-decoration-none text-white mb-5"
                        >
                  ...
                  {sportContents &&
                    sportContents.map((data) => {
                      return (
                        <div
                          key={data.id}
                          className="col-6 col-sm-6 col-lg-4 col-xl-3 my-2 "
                  ...
                  {hotContents &&
                    hotContents.map((data) => {
                      return (
                        <div
                          key={data.id}
                          className="col-6 col-sm-6 col-lg-4 col-xl-3 my-4 "
                          onClick={() => launchGame(data.id)}
                          style={{ cursor: "pointer" }}
                        >
                          <span

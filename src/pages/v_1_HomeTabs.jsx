          ...
          <Col xs={8} md={10} className='ps-4 ms-3 ms-sm-0'>
            <Tab.Content>
              ...
              <Tab.Pane className='container-fluid ' eventKey={1}>
                <h4 className='fw-bold mt-5' style={{ color: 'goldenrod' }}>
                  Slot Games
                </h4>
                <div className='row'>
                  {slotContents &&
                        ...
                        <Link
                          ...
                          onClick={() => {
                            ...
                            localStorage.setItem(
                              'gameType_id',
                              data.pivot.game_type_id
                            );
                            localStorage.setItem('title', data.description);
                          }}
                          key={data.id}
                          className='col-6 col-sm-6 col-lg-4 col-xl-3 my-sm-2 text-decoration-none text-white mb-4 mb-sm-5'
                        >
                  ...
                  {sportContents &&
                    sportContents.map((data) => {
                      return (
                        <div
                          key={data.id}
                          className='col-6 col-sm-6 col-lg-4 col-xl-3 my-sm-2 '
                  ...
                  {casinoContents &&
                    casinoContents.map((data) => {
                      return (
                        <div
                          key={data.id}
                          className='col-6 col-sm-6 col-lg-4 col-xl-3 my-sm-2 mb-4 mb-md-5 '
                          onClick={() => launchGame(data.id)}
                          style={{ cursor: 'pointer' }}
                        >
                          {/* <span>{data.description}</span> */}
                  ...
                  {casinoContents &&
                    casinoContents.map((data) => {
                      return (
                        <div
                          key={data.id}
                          className='col-6 col-sm-6 col-lg-4 col-xl-3 mb-4 my-sm-2 mb-sm-4 mb-md-5 '
                          onClick={() => launchGame(data.id)}
                          style={{ cursor: 'pointer' }}
                        >
                          {/* <span>{data.description}</span> */}
